...
type HelloRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HelloRequest  string                 `protobuf:"bytes,1,opt,name=helloRequest,proto3" json:"helloRequest,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HelloRequest) GetHelloRequest() string {
	if x != nil {
...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HelloResponse string                 `protobuf:"bytes,1,opt,name=helloResponse,proto3" json:"helloResponse,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HelloResponse) GetHelloResponse() string {
	if x != nil {
...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\aNoParam\"2\n" +
	"\fHelloRequest\x12\"\n" +
	"\fhelloRequest\x18\x01 \x01(\tR\fhelloRequest\"5\n" +
	"\rHelloResponse\x12$\n" +
	"\rhelloResponse\x18\x01 \x01(\tR\rhelloResponse\"!\n" +
	"\tNamesList\x12\x14\n" +
